...
- Name: pim.spec.js >> Flujo de Gestión de Empleados (PIM) >> Debería iniciar sesión y registrar el empleado (con manejo de ID duplicado)
- Location: tests\pim.spec.js:15:3
          ...
          - generic [ref=e161]:
            - generic [ref=e162]:
              - generic [ref=e165]:
                ...
                - generic [ref=e168]:
                  - textbox "First Name" [ref=e171]: firstName
                  - textbox "Middle Name" [active] [ref=e174]: middleName
